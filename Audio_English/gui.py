...
def onclick2():
    ...
    language_code = lang_map.get(folder, "en-US")
...
# img = ImageTk.PhotoImage(Image.open("/home/suresh/Desktop/Web-Scrapping-of-voice-newspaper-for-the-visually-Impaired--master/download.jpg"))
...
combo['values'] = ("http://www.bbc.com/news/world-asia-42126985", "https://www.gadgetsnow.com/tech-news/happy-to-receive-apple-awaiting-formal-proposal-says-prabhu/articleshow/61814415.cms?utm_source=toiweb&utm_medium=referral&utm_campaign=toiweb_hptopnews","http://money.cnn.com/2017/11/24/media/uma-thurman-harvey-weinstein-metoo/")
combo.current(0)
combo.pack()
